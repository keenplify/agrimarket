                                    ...
                                    <div class="card-body">
                                        <div class="author-box-left">
                                            <img alt="image" src="../img/user/<?php if ($rowuser->image == NULL) { ?>null.png<?php } else {
                                                                                                                            echo $rowuser->image; ?><?php } ?>" style="aspect-ratio: 1" class="ratio-1x1 rounded-circle author-box-picture">
                                                ...
                                                <!-- <div id="accordion">
                                                    <div class="accordion">
                                                        ...
                                                        <div class="accordion-body collapse bg-light" id="panel-body-1" data-parent="#accordion">
                                                            <center>
                                                                <img alt="image" src="../img/user/<?php if ($rowuser->image == NULL) { ?>null.png<?php } else {
                                                                                                                                                echo $rowuser->image; ?><?php } ?>" class="ratio-1x1 rounded-circle author-box-picture" style="width: 80%; aspect-ratio: 1">
                                                            </center>
                                                            <hr>
