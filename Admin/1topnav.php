<nav class="navbar navbar-expand-lg main-navbar">
            ...
            <ul class="navbar-nav navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <img alt="image" src="https://png.pngtree.com/element_our/sm/20180517/sm_5afd2b1f0ced7.png" class="ratio-1x1 rounded-circle mr-1" style="aspect-ratio: 1">
                    <div class="d-sm-none d-lg-inline-block">Hi, Admin</div></a>
                    <div class="dropdown-menu dropdown-menu-right">
                        <div class="dropdown-title">Active</div>
                        <a href="viewprofile.php" class="dropdown-item has-icon"><i class="far fa-user"></i> Profile</a>
                     ...
                     <!--    <a href="features-settings.html" class="dropdown-item has-icon"><i class="fas fa-cog"></i> Settings</a> -->
                        ...
                        <a href="login.php" class="dropdown-item has-icon text-danger"><i class="fas fa-sign-out-alt"></i> Logout</a>
                    </div>
                </li>
            </ul>
        </nav>