            ...
            <div class="main-content">
                <section class="section" id="printableArea">
                    ...
                    <div class="section-body">
                        ...
                        $orderId = $_GET["orderid"];
                        $slide12 = mysqli_query($con, "SELECT * FROM cart LEFT JOIN item ON cart.itemID = item.itemID LEFT JOIN account ON account.accountID = cart.accountID LEFT JOIN seller ON cart.orderSELLER = seller.sellerID WHERE orderID = '$orderId'") or die(mysqli_error($con));
