                                    ...
                                    <div class="card-header-form">
                                        <form method="get" class="d-flex">
                                            <select 
                                                ...
                                                onchange="municipalityFilter()"
                                                id="municipality-filter"
                                            >
                                                <option value="all">No Muxnicipality Filter</option>
                                                <?php 
                                ...
                                <div class="card-body p-0">
                                    <div class="table-responsive">
                                        <table class="table table-striped v_center">
                                            ...
                                            ?>
                                            <tr>
                                                <td><?php echo $rowseller->sellerfirstname;  ?> <?php echo $rowseller->sellerlastname;  ?></td>
                                                <td>
                                                <img alt="image" src="../img/user/<?php  if($rowuser->sellerimage==NULL){ ?>null.png<?php } else { echo $rowuser->sellerimage;?><?php } ?>" class="rounded-circle" width="35" data-toggle="tooltip" title="Wildan Ahdian">
                                                </td>
