                ...
                <div class="section-header">
                   <!--  <h1>Pending Order</h1> -->
                    <div class="section-header-breadcrumb">
                        <div class="breadcrumb-item active"><a href="#">Pick-Up/Recieved Order</a></div>
                    </div>
                </div>

                <div class="section-body">

                    <h2 class="section-title">Pick-Up/Recieved Order</h2>
...
$total=0;
 $dashboard=mysqli_query($con,"SELECT *  from cart  group by orderID, orderSELLER  ")or die(mysqli_error($con));
              ...
              {
                if ($rowdashboard->orderID != 1 && $rowdashboard->cartSTATUS == '7' ) {
...
<?php 
 ...
 ?>
                                                ...
                                                <td>  <span class="badge badge-info">Pick-Up/Recieved</span></td>
