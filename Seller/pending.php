                                            ...
                                            <table class="table table-striped v_center" id="table-1">
                                                ...
                                                <tbody>
                                                    ...
                                                    while ($rowdashboard = mysqli_fetch_object($slide12)) {
                                                        if ($rowdashboard->orderID != 1 && $rowdashboard->cartSTATUS == '2' && $rowdashboard->orderSELLER == $rowseller->sellerID) {
                                                            # code...
                                                    ?>
                                                            <tr>
                                                                ...
                                                                <td><b>₱<?= $rowdashboard->itemPRICE * $rowdashboard->cartCOUNT;  ?></b></td>
