                ...
                <section class="section">
                    <div class="section-header">
                        ...
                        <div class="section-header-breadcrumb">
                            <div class="breadcrumb-item active"><a href="#">Received/Picked-Up Orders</a></div>
                        </div>
                    </div>

                    <div class="section-body">

                        <h2 class="section-title">Received/Picked-Up Orders</h2>
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-striped v_center" id="table-1">
                                                ...
                                                <tbody>
                                                    <?php
                                                    $total = 0;
                                                    $dashboard = mysqli_query($con, "SELECT *  from cart where orderSELLER=$sellerID group by orderID, orderSELLER  ") or die(mysqli_error($con));
                                                    while ($rowdashboard = mysqli_fetch_object($dashboard)) {
                                                        if (
                                                            $rowdashboard->orderID != 1 && $rowdashboard->cartSTATUS == '5' && $rowdashboard->orderSELLER == $rowseller->sellerID &&
                                                    ...
                                                    ?>
                                                            <tr style="">
                                                                ...
                                                                <td> <span class="badge badge-info">Received/Picked-Up</span></td>
